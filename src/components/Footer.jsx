...
const Footer = () => {
    ...
    return (
        <div className=" pt-12 pb-12 md:p-12 text-white w-full bg-black flex justify-center items-center flex-col gap-4">
            ...
            <p className="text-sm md:md">  💻 github : https://github.com/Ayyanar022  <a target="_blank" className="text-orange-400 ml-5 hover:tracking-wider duration-300" href="https://github.com/Ayyanar022">Click Here</a> </p>
